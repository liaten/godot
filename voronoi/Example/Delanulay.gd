...
func set_rectangle(rect: Rect2) -> void:
	...
	# сохранить исходный прямоугольник
	
	# we expand rect to super rect to make sure
	# all future points won't be too close to broder
	# мы расширяем прямоугольник до суперпрямоугольника, чтобы убедиться, что
	...
	# вычислить и кэшировать треугольники для суперпрямоугольника
